      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              Оставьте заявку — мы дадим 7 дней бесплатного доступа и поможем настроить ассистента под ваш бизнес.
            </p>
            ...
            >
              <div>
                ...
                <a href="mailto:hello@contentai.io" className="text-foreground hover:text-sage transition-colors">
                  hello@contentai.io
                </a>
              </div>
              <div>
                <p className="text-xs tracking-widest uppercase text-muted-foreground mb-2">Работаем для</p>
                <p className="text-foreground">Instagram · TikTok · Сайты · Мессенджеры</p>
              </div>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Чем занимаетесь, для каких платформ нужен контент..."
                  required
                />
              </div>
              <button
