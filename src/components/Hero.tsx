  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Контент, который
          <span className="block text-sage">работает за вас</span>
        </h1>
        ...
        >
          Генерируйте посты для Instagram и TikTok, рекламные тексты и идеи акций — за секунды. Ваш персональный контент-ассистент на базе ИИ.
        </p>
