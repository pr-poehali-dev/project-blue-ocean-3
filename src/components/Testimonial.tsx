  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ContentAI полностью изменил нашу работу с соцсетями. Раньше я тратила 3 часа в неделю на посты — теперь 20 минут. И результат даже лучше.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Мария Соколова</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Владелец кофейни «Утро», Берлин</p>
        </div>
      </div>
    </section>
  )
